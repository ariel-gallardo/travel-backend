...
namespace Presentation.Controllers
{
    ...
    public class VehiculosController : ControllerBase, ControllerMethods<Models.Output.Vehiculo, Models.Input.Vehiculo, VehiculosFilter>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromForm] Models.Input.Vehiculo t)
        {
        ...
        [ProducesResponseType(typeof(Models.Output.Output<bool>), StatusCodes.Status404NotFound)]
        [HttpGet("all/{page}")]
        public async Task<IActionResult> FindAll(int page, [FromQuery] VehiculosFilter fModel, [FromQuery] bool useFilter)
        {
        ...
        [ProducesResponseType(typeof(Models.Output.Output<bool>), StatusCodes.Status404NotFound)]
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromForm] Models.Input.Vehiculo t, long id)
        {
