...
namespace Presentation.Controllers
{
    ...
    public class CiudadesController : ControllerBase, ControllerMethods<Models.Output.Ciudad, Models.Input.Ciudad, CiudadesFilter>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromForm] Models.Input.Ciudad t)
        {
        ...
        [ProducesResponseType(typeof(Models.Output.Output<bool>), StatusCodes.Status404NotFound)]
        [HttpGet("all/{page}")]
        public async Task<IActionResult> FindAll(int page, [FromQuery] CiudadesFilter fModel, [FromQuery] bool useFilter)
        {
        ...
        [ProducesResponseType(typeof(Models.Output.Output<bool>), StatusCodes.Status404NotFound)]
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromForm] Models.Input.Ciudad t, long id)
        {
